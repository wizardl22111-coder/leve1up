        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              <img src="/images/levelup-logo.png" alt="<img src="/images/levelup-logo.png" alt="Level Up" className="inline h-6 w-auto object-contain mx-1" />" className="inline h-6 w-auto object-contain mx-1" />
            </p>
          </div>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <div className="bg-gradient-to-br from-primary-50 to-accent-50 dark:from-primary-900/20 dark:to-accent-900/20 p-6 rounded-xl mb-8">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                مرحبًا بكم في <img src="/images/levelup-logo.png" alt="<img src="/images/levelup-logo.png" alt="Level Up" className="inline h-6 w-auto object-contain mx-1" />" className="inline h-6 w-auto object-contain mx-1" />، المتخصص ببيع الألعاب الرقمية، الأكواد، الحسابات والمنتجات الإلكترونية.
              </p>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border-r-4 border-primary-600 dark:border-primary-400">
                ...
                <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                  <li className="flex gap-3">
                    ...
                    <span><strong>المتجر:</strong> <img src="/images/levelup-logo.png" alt="<img src="/images/levelup-logo.png" alt="Level Up" className="inline h-6 w-auto object-contain mx-1" />" className="inline h-6 w-auto object-contain mx-1" /> الإلكتروني بكافة قنواته (الموقع الإلكتروني – التطبيق – الدعم الفني).</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary-600 dark:text-primary-400">•</span>
