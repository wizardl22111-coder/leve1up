      ...
      <div className="space-y-6">
        ...
        >
          <div className="p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">قائمة المنتجات</h3>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-700/50">
                    <th className="text-right py-3 px-4 text-slate-300 font-medium">المنتج</th>
                    <th className="text-right py-3 px-4 text-slate-300 font-medium">السعر</th>
                    <th className="text-right py-3 px-4 text-slate-300 font-medium">الحالة</th>
                    <th className="text-right py-3 px-4 text-slate-300 font-medium">المبيعات</th>
        ...
        >
          ...
          <p className="text-slate-300">
            هذه الصفحة قيد التطوير. سيتم إضافة وظائف إدارة المنتجات قريباً.
          </p>
        </motion.div>
      </div>
    </AdminLayout>
