...
const ProductDescriptionBoxes: React.FC<ProductDescriptionBoxesProps> = ({ productId, productName }) => {
  ...
  const getProductBoxes = (id: number) => {
    switch (id) {
      ...
      case 11: // منتج جديد - يمكن تخصيصه حسب المنتج الفعلي
        return {
          box1: {
            title: "📦 ما ستحصل عليه:",
            items: [
              "منتج رقمي عالي الجودة",
              "محتوى حصري ومميز",
              "تحديثات مجانية",
              "دعم فني متكامل"
            ]
      ...
      case 12: // منتج جديد - يمكن تخصيصه حسب المنتج الفعلي
        return {
          box1: {
            title: "🎯 ما ستتعلمه:",
            items: [
              "مهارات متقدمة وعملية",
              "تقنيات حديثة ومجربة",
              "استراتيجيات ناجحة",
      ...
      case 13: // منتج جديد - يمكن تخصيصه حسب المنتج الفعلي
        return {
          box1: {
            title: "🛠️ الأدوات المتضمنة:",
            items: [
      ...
      case 14: // Discord Nitro سنة واحدة
        return {
          box1: {
            title: "🎮 ما ستحصل عليه:",
            items: [
              "Discord Nitro لمدة 12 شهر كاملة",
              "رفع ملفات حتى 100MB",
              "جودة فيديو عالية 1080p/60fps",
              "2 Server Boosts مجانية"
            ]
          },
          box2: {
            title: "✨ المميزات الحصرية:",
            items: [
              "إيموجي مخصصة في جميع السيرفرات",
              "شارة Nitro المميزة",
              "ملف شخصي محسّن ومتحرك",
              "مجموعة ألوان حصرية"
            ]
          },
          box3: {
            ...
            items: [
              ...
              "كود التفعيل عبر البريد الإلكتروني",
              "تعليمات التفعيل مرفقة",
              "دعم فني في حالة المساعدة"
            ]
          },
          box4: {
            title: "👥 مناسب لـ:",
      ...
      case 15: // Discord Nitro 3 أشهر
        return {
          box1: {
            title: "🎮 ما ستحصل عليه:",
            items: [
              "Discord Nitro لمدة 3 أشهر",
              "رفع ملفات حتى 100MB",
              "جودة فيديو عالية 1080p/60fps",
              "2 Server Boosts مجانية"
            ]
