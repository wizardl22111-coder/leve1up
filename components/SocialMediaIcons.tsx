    ...
    <div className={`social-media-container ${className}`}>
      ...
      <ul className="social-icons">
        ...
        <li className="icon-content">
          ...
          <div className="tooltip">إنستغرام</div>
        </li>
        ...
        <li className="icon-content">
          ...
          >
            ...
            >
              <path
                fill="currentColor"
                d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-.88-.05A6.33 6.33 0 0 0 5.16 20.5a6.33 6.33 0 0 0 10.86-4.43V7.83a8.24 8.24 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.2.74z"
              />
            </svg>
          </a>
          <div className="tooltip">تيك توك</div>
        </li>
      </ul>
    </div>
  );
